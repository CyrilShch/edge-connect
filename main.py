...
def main(mode=None, writer=None):
    r"""starts the model
...
def load_config(mode=None):
    ...
    parser.add_argument('--path', '--checkpoints', type=str, default='/content/', help='model checkpoints path (default: ./checkpoints)')
    ...
    if not os.path.exists(config_path):
        copyfile('/content/edge-connect/config.yml.example', config_path)
